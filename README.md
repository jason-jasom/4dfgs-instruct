...
2. Use Instruct-4DGS to generate edited multi-view images:
...
3. Generate the corresponding edited video using the workflow in ```script.sh```. Replace each placeholder with your own paths and settings:
